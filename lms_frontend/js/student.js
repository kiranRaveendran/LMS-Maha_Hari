...
async function editManager(id){
    ...
    try{
        ...
        const response = await axios.get(
            ...
            `${API.BASE_URL}/api/accounts/students/${id}/`,
...
async function loadManagers(){
    ...
    try{
        ...
        const response = await axios.get(
            ...
            `${API.BASE_URL}/api/accounts/students/`,
    ...
    try{
        ...
        if(editingManagerId){
            ...
            response = await axios.patch(
                ...
                `${API.BASE_URL}/api/accounts/students/${editingManagerId}/`,
...
async function deleteManager(){
    ...
    try{
        ...
        await axios.delete(
            ...
            `${API.BASE_URL}/api/accounts/students/${deleteManagerId}/`,
