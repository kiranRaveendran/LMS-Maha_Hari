...
async function editManager(id){
    ...
    try{
        ...
        const response = await api.get(`${API.BASE_URL}/api/accounts/faculties/${id}/`);
...
// ===============================
// Load Faculty (server-side paginated + searched)
// ===============================
...
async function loadManagers(page = 1){
    ...
    try{
        ...
        const response = await api.get(`${API.BASE_URL}/api/accounts/faculties/`, { params });
...
function showLoading(){
    ...
    <tr>
        ...
        <p class="mt-3">Loading Facultys...</p>
        </td>
    </tr>
    `;
...
async function saveManager(){
    ...
    try{
        ...
        if(editingManagerId){
            await api.patch(`${API.BASE_URL}/api/accounts/faculties/${editingManagerId}/`, payload);
        }
        else{
            await api.post(`${API.BASE_URL}/api/accounts/faculties/`, payload);
        }
        ...
        saveManagerBtn.innerHTML = `<i class="bi bi-check-circle me-2"></i>Save Faculty`;
...
async function deleteManager(){
    ...
    try{
        ...
        await api.delete(`${API.BASE_URL}/api/accounts/faculties/${deleteManagerId}/`);

        deleteManagerModal.hide();
        showSuccessMessage("Faculty deleted successfully.");
