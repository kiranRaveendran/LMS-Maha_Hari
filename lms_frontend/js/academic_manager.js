...
function registerEvents(){
    ...
    // Debounced search — resets to page 1 on every change, waits
    // 350ms after typing stops before hitting the server, so we're
...
function openAddModal(){
    ...
    document.getElementById("modalTitle").textContent = "Add Academic Manager";
    managerModal.show();
...
async function editManager(id){
    ...
    try{
        ...
        const response = await api.get(`${API.BASE_URL}/api/accounts/academic-managers/${id}/`);
        ...
        document.getElementById("modalTitle").textContent = "Edit Academic Manager";
...
// ===============================
// Load Managers (server-side paginated + searched)
// ===============================
...
async function loadManagers(page = 1){
    ...
    try{
        ...
        const response = await api.get(`${API.BASE_URL}/api/accounts/academic-managers/`, { params });
...
function showLoading(){
    ...
    <tr>
        ...
        <p class="mt-3">Loading Academic Managers...</p>
        </td>
    </tr>
    `;
...
async function saveManager(){
    ...
    try{
        ...
        if(editingManagerId){
            await api.patch(`${API.BASE_URL}/api/accounts/academic-managers/${editingManagerId}/`, payload);
        }
        else{
            await api.post(`${API.BASE_URL}/api/accounts/academic-managers/`, payload);
        }
        ...
        saveManagerBtn.innerHTML = `<i class="bi bi-check-circle me-2"></i>Save Manager`;

        // New records land on page 1; edits stay on the current page
...
async function deleteManager(){
    ...
    try{
        ...
        await api.delete(`${API.BASE_URL}/api/accounts/academic-managers/${deleteManagerId}/`);

        deleteManagerModal.hide();
        showSuccessMessage("Academic Manager deleted successfully.");
        ...
        console.error(error);
        alert("Failed to delete Academic Manager.");
    }
